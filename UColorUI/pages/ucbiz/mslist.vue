...
<template>
	<view>
		<cu-custom bgColor="bg-gradual-blue" :isBack="true"><block slot="backText">返回</block><block slot="content">秒杀商品列表</block></cu-custom>
	
		<ucb-msList :list="goodslist" mainstyle="common" :iscard="false"></ucb-msList>
		
		<ucb-msList :list="goodslist" mainstyle="double" :iscard="true"></ucb-msList>
		
		<ucb-msList :list="goodslist" mainstyle="bigcard" :iscard="false"></ucb-msList>
