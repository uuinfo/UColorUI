 ...
 /**
  * uc-post-news  动态发布页面组件
  * @property {String} btncolor 设置发布按钮颜色,值为mian.css中的bg开头的值，例bg-orange
  * @example <uc-post-news btnColor="bg-red"></uc-post-news>
  */
...
<template>
	<view>
		...
		<view class="padding-xl text-center"><button class="cu-btn round shadow" :class="btnColor">发布</button></view>
	</view>
</template>
